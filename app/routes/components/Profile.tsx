export default function Profile(){
  return (
  <>
    <h1 className="text-2xl text-neutral-50 text-center bg-red-900 font-bold p-5">Profile</h1>
    <div className="p-10 rounded">
        ...
        <p className="text-center text-gray-700 bg-red-50 border-2 rounded w-1/2 mx-auto p-5">---<br />
